...
def introducir_inputs(x, y, z):
  ...
  while a in range(len(x)):
    keys = x[a]
    values = input(f'Por favor, introduzca el gasto de {x[a]}: ')
    try:
      float(values)
    except:
...
mediaDuraderos = (7200, 1170, 1150, 300)
mediaServicios = (1000, 437, 1300, 1700)
mediaPerecederos = (1600, 1800, 1385, 510)
mediaTotal = (7200, 1170, 1150, 300, 1000, 437, 1300, 1700, 1600, 1800, 1385, 510)
